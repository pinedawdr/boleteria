...
export default function BookingsAdmin() {
  ...
  if (loading) {
    return <AdminLoadingState message="Cargando reservas..." />
  }
        ...
        <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 min-h-[80px]">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-accent to-success bg-clip-text text-transparent flex items-center gap-3">
              <Ticket className="w-6 h-6 sm:w-8 sm:h-8 text-accent" />
              Gestión de Reservas
            </h1>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button 
              ...
              className="px-4 py-2 bg-accent hover:bg-accent/80 text-black rounded-lg transition-colors flex items-center gap-2"
            >
