...
export default function EventsManagementPage() {
  ...
  if (loading) {
    return <AdminLoadingState message="Cargando eventos..." />
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors"
              >
