...
const mockEvents: EventDetails[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    duration: '8 horas',
    event_type: 'hybrid' // Conferencias híbridas no necesitan asientos específicos
  },
  {
    id: '4',
    ...
    rating: 4.5,
    duration: '2 horas',
    event_type: 'presential' // Deportes en estadios SÍ necesitan asientos específicos
  },
  {
    id: '5',
    ...
    rating: 4.4,
    duration: '6 horas',
    event_type: 'presential' // Fiestas en clubs generalmente son entrada general
  },
  {
    id: '6',
    ...
    rating: 4.3,
    duration: '2 horas',
    event_type: 'virtual' // Webinars virtuales NO necesitan asientos
  }
]
      ...
      <Container className="py-8">
        ...
        <div className="text-center mb-8 md:mb-12">
          <h1 className="text-3xl md:text-5xl font-bold text-primary mb-4 animate-fadeIn">
            Descubre Eventos <span className="text-accent">Increíbles</span>
          </h1>
